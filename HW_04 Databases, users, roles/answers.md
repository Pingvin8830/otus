...
* расскажите что получилось и почему
  * В команде создания таблицы в явном виде не указана схема. Все схемы, которые указаны в search_path недоступны для пользователя testread, поэтому команда CREATE TABLE завершилась с ошибкой. Т.к. таблица не создалась, то команда INSERT не смогла вставить данные и тоже завершилась с ошибкой
